...
// define parameter from data preprocessing (at notebook file)
const maxlen = 20;
...
// ----Function `predict()`-----
// Function for predict sentiment
...
// ----Function `onClick()`-----
// Function for user click "Post Review"
function onClick(){
...
async function init(){
    ...
    // Replace with your live server port
    ...
    //call word_index
    const word_indexjson = await fetch('http://127.0.0.1:5500/models/word_index.json'); 
